...
public final class VT100 {
	...
	private static void reset_device(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001bc");
	}

	/** Text wraps to next line if longer than the length of the display area. */
	private static void enable_line_wrap(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[7h");
	}

	/** Disables line wrapping. */
	private static void disable_line_wrap(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[7l");
	}
	...
	/** Set default font. */
	private static void font_set_g0(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b(");
	}

	/** Set alternate font. */
	private static void font_set_g1(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b)");
	}
   ...
   public static void unsave_cursor() {
	...
	private static void enable_screen_scroll(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[r");
	}

	/** Enable scrolling from row {start} to row {end}. */
	private static void scroll_screen(int start, int end){
		throw new UnsupportedOperationException("not implemented yet"); 
	...
	private static void set_tab(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001bH");
	}

	/** Clears tab at the current position. */
	private static void clear_tab(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[g");
	}

	/** Clears all tabs. */
	private static void clear_all_tabs(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[3g");
	}
	...
	private static void print_screen(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[i");
	}
	...
	/** Disable log. */
	private static void stop_print_log(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[4i");
	}

	/** Start log; all received text is echoed to a printer. */
	private static void start_print_log(){
		throw new UnsupportedOperationException("not implemented yet"); 
		// System.out.print("\u001b[5i");
	}
}
